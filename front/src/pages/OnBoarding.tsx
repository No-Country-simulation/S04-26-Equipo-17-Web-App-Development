...
const requirements = [
    ...
    },
    {
        id: "02",
        title: "Documentos",
        subtitle: "Cédula + comprobante de domicilio",
        icon: FileText,
    },
    {
        id: "03",
        title: "Contrato",
        subtitle: "Lee y firma tu acuerdo",
        icon: FileBadge2,
    },
    {
        id: "04",
        title: "Pago",
        subtitle: "Banco local, Wise o USDC — tú eliges",
        icon: Banknote,
    },
    {
        id: "05",
        title: "Identidad",
        subtitle: "Una selfie rápida (~30 seg)",
        icon: IdCard,
    },
] as const;

const highlights = [
    { title: "USD 5.200", subtitle: "Tarifa mensual", icon: Building2 },
    { title: "12 meses", subtitle: "Duración", icon: CircleCheckBig },
    { title: "Net 5", subtitle: "Ciclo de pago", icon: HandCoins },
    { title: "COP / USD", subtitle: "Eliges tu moneda", icon: Wallet },
] as const;
            ...
            <section className="grid min-h-dvh w-full bg-[#f5efe8] lg:grid-cols-[1.04fr_1fr]">
                <article className="relative overflow-hidden p-6 sm:p-8 lg:flex lg:flex-col lg:justify-between lg:p-10">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="mt-7 space-y-4">
                            <h1 className="max-w-[18ch] text-[2.5rem] leading-[0.95] font-bold tracking-tight text-[#182134] sm:text-[3.2rem]">
                                ¡Hola, Sofía! 👋
                                <br />
                                <span className="text-[#727b92]">Lattice &amp; Loop quiere pagarte sin enredos.</span>
                            </h1>
                            <p className="max-w-[44ch] text-sm leading-relaxed text-[#3e4a62] sm:text-lg">
                                Te acompañamos en 5 pasos, en unos 10 minutos. Tus datos están cifrados y solo se usan para configurar tu pago.
                            </p>
                        </div>
                    ...
                    <p className="relative z-10 mt-5 flex items-center gap-2 text-[0.68rem] text-[#7d859c] sm:text-xs lg:mt-6">
                        ...
                        Al continuar aceptas nuestra Política de Privacidad y Términos.
                    </p>
                </article>
